...
class FollowerRaceVC: UIViewController {
...
extension FollowerRaceVC {
    ...
    fileprivate func configureLabels() {
        ...
        descriptionLabel.text = "Ne perdez plus jamais de vue vos coureurs favoris dans les sentiers !"
    }
...
extension FollowerRaceVC : UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let specificRace = BigFollowerRaceVC()
